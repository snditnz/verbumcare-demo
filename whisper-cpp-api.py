...
async def transcribe(
    ...
    try:
        ...
        # Add medical terminology prompt for Japanese
        if language == "ja":
        ...
        for segment in whisper_output.get("transcription", []):
            ...
            if seg_text:
                segments.append({
                    "start": f"{segment['offsets']['from'] / 1000:.3f}",
                    "end": f"{segment['offsets']['to'] / 1000:.3f}",
                    "text": seg_text
                })
                full_text += seg_text + " "
        ...
        return {
            ...
            "language_probability": "1.0000",  # whisper-cpp doesn't provide this
            "duration": duration,
